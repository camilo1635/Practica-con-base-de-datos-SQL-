...
$sql1 = "INSERT into datos_medidos (fecha, hora,temperatura, humedad_aire, iluminacion, humedad_tierra) VALUES (CURDATE(), CURTIME(),'$temperatura', '$humedad_aire', '$luz', '$humedad_tierra' )"; // Aqu� se ingresa el valor recibido a la base de datos.
